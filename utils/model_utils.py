...
có BatchNorm1d ngay sau nó -> downsample là Conv1d -> BatchNorm1d.
"""
...
class TCNResidualBlock(nn.Module):
    ...
    Cấu trúc:
        Conv1d -> Chomp -> BatchNorm -> ReLU -> Dropout
        -> Conv1d -> Chomp -> BatchNorm -> ReLU -> Dropout
...
class ArcNN(nn.Module):
    ...
    def forward(self, x, extract_features=False):
        ...
        # Vector 1024 chiều dùng cho PCA.
        if extract_features:
            return features
...
class SHLNN(nn.Module):
    ...
    num_inputs được truyền từ số chiều PCA thực tế.
    """
